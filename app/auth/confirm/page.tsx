  ...
  useEffect(() => {
    ...
    const checkSession = async () => {
      try {
        ...
        if (session) {
          setStatus('success')
          // Po 3 sekundách presmeruj na dashboard
          setTimeout(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 border-2 border-amber-500/50 text-center">
          ...
          {status === 'success' && (
            <>
              ...
              <Link 
                href="/dashboard"
                className="inline-block mt-4 px-8 py-4 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-white rounded-lg font-bold text-lg hover:from-amber-500 hover:to-amber-700 transition-colors shadow-lg shadow-amber-500/20"
              >
          ...
          {status === 'error' && (
            <>
              ...
              <div className="flex gap-4 justify-center">
                <Link 
                  href="/login"
                  className="px-6 py-3 bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 text-white rounded-lg font-bold hover:from-amber-500 hover:to-amber-700 transition-colors shadow-lg shadow-amber-500/20"
                >
                  Prihlásiť sa
                </Link>
                <Link 
